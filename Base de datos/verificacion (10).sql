...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-03-2023 a las 20:46:37
...
--
-- Estructura de tabla para la tabla `tb_validacion`
--
...
--
-- Volcado de datos para la tabla `tb_validacion`
--
...
--
-- Indices de la tabla `tb_validacion`
--
...
--
ALTER TABLE `tb_detalletara`
  MODIFY `Id_DetalleTara` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=259;

--
-- AUTO_INCREMENT de la tabla `tb_detalleverificacion`
--
ALTER TABLE `tb_detalleverificacion`
  MODIFY `Id_DetalleVerificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1027;
...
--
-- AUTO_INCREMENT de la tabla `tb_validacion`
--
ALTER TABLE `tb_validacion`
  MODIFY `Id_Validacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `tb_verificacion`
--
ALTER TABLE `tb_verificacion`
  MODIFY `Id_Verificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=534;
...
--
-- Filtros para la tabla `tb_validacion`
--
ALTER TABLE `tb_validacion`
