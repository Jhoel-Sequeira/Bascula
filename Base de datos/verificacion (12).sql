...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2023 at 11:57 PM
...
(18, 'josue.martinez@crn.com.ni', 'pbkdf2:sha256:260000$KOX4QNgzlELbZ2Le$076aa86fe9ed687a0722a8d80530e15b7bac5135f79d2236d1861c419cb0957d', 2);
...
(1334, 688, 39, 50, 7.5, 42.5, 0),
(1335, 689, 39, 50, 7.5, 42.5, 0),
(1336, 688, 17, 35, 0, 35, 0),
(1337, 689, 17, 35, 0, 35, 0),
(1338, 688, 32, 85, 7.5, 77.5, 0),
(1339, 689, 32, 85, 7.5, 77.5, 0),
(1340, 691, 39, 10, 0, 10, 0),
(1341, 690, 39, 20, 0, 20, 0);
...
(18, 'JOSUÉ MARTINEZ', NULL, 1, 253, 18, 1, 1);
...
(688, '2023-05-03 10:45:29', 'PO165574', 'CASETA', 28, 4, 18, 10, 1, 9, 18),
(689, '2023-05-03 10:45:30', 'PO165574', 'CASETA', 28, 4, 18, 10, 1, 9, 4),
(690, '2023-05-03 10:45:36', '--', 'CASETA', 24, 4, 18, 10, 1, 3, 18),
(691, '2023-05-03 10:45:40', '--', 'CASETA', 24, 4, 18, 10, 1, 3, 4);
...
--
ALTER TABLE `tb_credenciales`
  MODIFY `Id_Credenciales` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `tb_desbloqueos`
--
ALTER TABLE `tb_desbloqueos`
  MODIFY `Id_Desbloqueo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tb_detalletara`
--
ALTER TABLE `tb_detalletara`
  MODIFY `Id_DetalleTara` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=276;

--
-- AUTO_INCREMENT for table `tb_detalleverificacion`
--
ALTER TABLE `tb_detalleverificacion`
  MODIFY `Id_DetalleVerificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1342;
...
--
ALTER TABLE `tb_validacion`
  MODIFY `Id_Validacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `tb_verificacion`
--
ALTER TABLE `tb_verificacion`
  MODIFY `Id_Verificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=692;
