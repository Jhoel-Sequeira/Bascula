...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-02-2023 a las 20:59:31
...
(55, 23, 34, 30, 11, 19, 0),
(57, 23, 53, 100, 30, 100, 0),
(63, 25, 53, 100, 40, 100, 0),
(64, 25, 34, 100, 50, 100, 0),
(65, 25, 52, 0, 20, -20, 0),
(66, 25, 53, 0, 30, -20, 0),
(67, 25, 34, 0, 0, 0, 0),
(68, 25, 1, 0, 30, 0, 0),
...
(23, '2023-02-09 07:40:47', 'PO', 1, 1, 1, 4, 1, 5, 3, 1),
(24, '2023-02-09 07:40:47', 'PO79293', 2, 8, 2, 4, 2, 1, 3, 2),
(25, '2023-02-09 09:55:51', 'PRUEBAS', 8, 8, 1, 4, 1, 2, 4, 1),
(26, '2023-02-09 13:29:22', 'PI', 2, 13, 1, 4, 1, 6, 3, 1),
(27, '2023-02-09 13:48:44', 'PO015', 4, 9, 1, 4, 1, 7, 3, 1);
...
--
ALTER TABLE `tb_detalletara`
  MODIFY `Id_DetalleTara` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;

--
-- AUTO_INCREMENT de la tabla `tb_detalleverificacion`
--
ALTER TABLE `tb_detalleverificacion`
  MODIFY `Id_DetalleVerificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
...
--
ALTER TABLE `tb_verificacion`
  MODIFY `Id_Verificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
